...
public interface StagesAdmissionRepository extends JpaRepository <StagesAdmission,Long> {
    ...
    String findBachelor(String level,String speciality, String government_order,String full_time);

    @Query(value = "select u.dates from StagesAdmission u where u.educational_level = :level AND u.speciality = :speciality")
    String findMaster(String level,String speciality);
}
